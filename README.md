...
- Includes a separate full-screen browser FPS duel window with pointer-lock mouse aim, WASD movement, HP, armor, ammo, weapon switching, reloads, enemy AI, radar-style HUD data, and a local arena background at `assets/duel-arena.png`.
